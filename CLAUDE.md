...
## Keywords
electron, ai-assistant, real-time, screen-capture, audio-capture, overlay, gemini, ollama, whisper, websocket, lit

## Annotation
Electron-приложение для AI-ассистирования в реальном времени во время видеозвонков и профессиональных разговоров. Захватывает экран и аудио, анализирует через AI (Gemini/Ollama/Cloud) и отображает контекстные подсказки в overlay-окне.
